...
%         firsthalf_data=allanswers_noiserun_all(firsthalf_all,:);
%         dataforincludedsounds=firsthalf_data(ismember(firsthalf_data(:,22), includedsounds),:);
%         
        
        secondhalf_data=allanswers_noiserun_all(secondhalf_all,:);
        dataforincludedsounds=secondhalf_data(ismember(secondhalf_data(:,22), includedsounds),:);
        
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
       %%%%%%%%%%question1%%%%%%%%%%%%%
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 

%         dataforblanks=firsthalf_data((firsthalf_data(:,22)==0),:);
                dataforblanks=secondhalf_data((secondhalf_data(:,22)==0),:);
