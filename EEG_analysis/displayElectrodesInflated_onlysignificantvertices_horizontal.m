            ...
            for length_baseline=1 %length(baseline_lengths)
                ...
                for baseline_inclusion=1 %length(baseline_stats_1)
                    ...
                    for parcelsnumbers=1:length(parceldivisions)
                        ...
                        parcel_flavor=['kmeans_mask_refined'];
                        ...
                        save_location=[save_location_1 save_location_2_2 '\' save_location_2 '\'  save_location_3 '_balanced'];
                        ...
                        if strcmp(baselinetype, '_common_b')
  ...
  on the following files being present in each patient's overlay data folder:
    ...
    - 'R_MontageMap.mat': Contains the data from 'MontageMap.mat' belonging
                        ...
                        switch overlay
                            ...
                            case 'CP'
                                image_storage_folder = [save_location '/Gamma_power_CP' suffix];
                            case 'CNP'
                                image_storage_folder = [save_location '/Gamma_power_CNP' suffix];
                            case 'Electrode Density'
                                image_storage_folder = [save_location '/Electrode_Density'];
                            case 'Subtraction'
                                image_storage_folder = [save_location '/Gamma_power_Subtraction' suffix];
                            case 'Comparison'
                        ...
                        for frame_index = 1 : all_frames_num
                            ...
                            for side_index = start_side : sides_num
                                if side_index == 1
                                    ...
                                    combined_views_left{frame_index} = cat(2, L_Ventral, L_Lateral, L_Medial);
                                ...
                                elseif side_index == 2
                                    ...
                                    combined_views_right{frame_index} = cat(2, R_Medial, R_Lateral, R_Ventral);
