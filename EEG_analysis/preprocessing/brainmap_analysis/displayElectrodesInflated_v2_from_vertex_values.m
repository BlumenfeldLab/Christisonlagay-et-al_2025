function displayElectrodesInflated_v2_from_vertex_values(data_location, save_location, patients,...
    overlay, laterality, color_map, color_map_inner_bounds,...
    color_map_outer_bounds, views, inflationstep, plot_electrodes,...
    xtick_spacing_filename, vertex_valuesL, vertex_valuesR, display_color_bar, stim_offset, varargin)
