function displayElectrodesInflated(data_location, save_location, patients,...
    overlay, createMontage, laterality, views, inflationstep, electrodeDensity,...
    subtraction, file_suffixes, plot_electrodes, varargin) %, frames_set)
