function displayElectrodesInflated_v2_fs(data_location, save_location, patients,...
    overlay, createMontage, laterality, color_map, color_map_inner_bounds,...
...
for side_index = start_side : sides_num
    ...
    % commented section below takes fs surface to MNI space
